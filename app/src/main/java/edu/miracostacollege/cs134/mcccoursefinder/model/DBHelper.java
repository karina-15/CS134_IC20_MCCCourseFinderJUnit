...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public int deleteCourse(Course course) {
        if(course == null)
            return 0;  // -1 to indicate there was an error
                        // or 0 to indicate courses were deleted
        SQLiteDatabase db = this.getWritableDatabase();

        // DELETE THE TABLE ROW
        // SQLiteDatabase delete returns # or rows deleted
        int rowsDeleted = db.delete(COURSES_TABLE, COURSES_KEY_FIELD_ID + " = ?",
